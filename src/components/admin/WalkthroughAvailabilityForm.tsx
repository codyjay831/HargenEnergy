...
import {
  updateWalkthroughAvailabilitySettings,
  type WalkthroughAvailabilitySettingsInput,
...
import type { WeekdayKey, WeekdayWindows } from "@/lib/walkthrough-scheduling/types";
...
export type WalkthroughAvailabilityFormSettings = {
  timezone: string;
...
interface WalkthroughAvailabilityFormProps {
  initialSettings: WalkthroughAvailabilityFormSettings;
}
...
export function WalkthroughAvailabilityForm({ initialSettings }: WalkthroughAvailabilityFormProps) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload: WalkthroughAvailabilitySettingsInput = {
      timezone,
    ...
    startTransition(async () => {
      try {
        await updateWalkthroughAvailabilitySettings(payload);
